...
function Like(props) {
    ...
    const onLike = () => {
        ...
        if (props.likeAction === "") {
            ...
            Axios.post('http://localhost:5000/api/like/upLike',{answerId:props.id},{
                headers:{
            ...
            Axios.post('http://localhost:5000/api/like/unLike', {answerId:props.id}, {
                headers: {
                    Authorization: userInfo1.token
                }
            })
    ...
    return (
                <div 
                    ...
                    className="upvotes">
                    {
                        ...
                        <LikeFilled style={{fontSize:"20px", marginTop:"6px"}}
                         onClick={onLike}/>
                        :
                        <LikeOutlined style={{fontSize:"20px", marginTop:"6px"}}
                        onClick={onLike}
                        />
                    }
